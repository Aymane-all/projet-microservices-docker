        ...
        <div className="pt-2 pb-3 space-y-1 border-t border-gray-200">
          {isAuthenticated ? (
            <>
              <Link
                to={getHomeLink()}
                className="flex items-center px-4 py-2 text-base font-medium text-gray-600 hover:text-primary-500 hover:bg-gray-50"
                onClick={() => setIsMenuOpen(false)}
              >
              ...
              <button
                onClick={handleLogout}
                className="flex w-full items-center px-4 py-2 text-base font-medium text-gray-600 hover:text-primary-500 hover:bg-gray-50"
              >
