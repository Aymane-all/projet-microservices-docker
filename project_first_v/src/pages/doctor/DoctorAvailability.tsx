...
const DoctorAvailability = () => {
  ...
  // In a real app, this would fetch the doctor's current availability from an API
  useEffect(() => {
    // Simulating loading existing availability data
    setIsLoading(true);
    setTimeout(() => {
  ...
  const addTimeSlot = () => {
    ...
    // Add the new time slot to the selected day
    ...
    setAvailabilities(prevAvailabilities => 
      prevAvailabilities.map(availability => 
        availability.day === day
          ? {
              ...availability,
              slots: availability.slots.filter((_, index) => index !== slotIndex)
            }
          : availability
      )
    );
