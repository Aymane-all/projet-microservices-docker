        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-gray-50 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:transform hover:scale-105">
              ...
              />
              <div className="p-6">
                <p className="text-sm font-medium text-primary-600">Dermatology</p>
                <h3 className="mt-1 text-xl font-semibold text-gray-900">Dr. Michael Johnson</h3>
                <div className="flex items-center mt-2">
                  <div className="flex items-center">
                    {[0, 1, 2, 3, 4].map((rating) => (
                      <svg
                  ...
                  <p className="ml-2 text-sm text-gray-600">4.6 • 95+ reviews</p>
                </div>
                <p className="mt-3 text-gray-500">
                  Expert in treating various skin conditions with a patient-centered approach.
                </p>
                <div className="mt-6">
                  <Link to={isAuthenticated ? "/patient/book/2" : "/login"}>
                    <Button fullWidth>Book Appointment</Button>
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:transform hover:scale-105">
              ...
              />
              <div className="p-6">
                <p className="text-sm font-medium text-primary-600">Pediatrics</p>
                <h3 className="mt-1 text-xl font-semibold text-gray-900">Dr. Sarah Williams</h3>
                <div className="flex items-center mt-2">
                  <div className="flex items-center">
                    {[0, 1, 2, 3, 4].map((rating) => (
                      <svg
                  ...
                  <p className="ml-2 text-sm text-gray-600">4.9 • 150+ reviews</p>
                </div>
                <p className="mt-3 text-gray-500">
                  Compassionate pediatrician dedicated to the health and well-being of children.
                </p>
                <div className="mt-6">
                  <Link to={isAuthenticated ? "/patient/book/3" : "/login"}>
                    <Button fullWidth>Book Appointment</Button>
                  </Link>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform offers unique advantages for both patients and healthcare providers.
            </p>
          </div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Access healthcare services and book appointments anytime, day or night.
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    All healthcare providers are thoroughly verified and credentialed.
                  </p>
                </div>
              </div>
      ...
      <div className="bg-primary-500">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-accent-300">Create your account today.</span>
          </h2>
